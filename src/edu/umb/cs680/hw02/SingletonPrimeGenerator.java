...
class SingletonPrimeGenerator {
	private static SingletonPrimeGenerator single_instance = null;
	...
	public static synchronized SingletonPrimeGenerator getInstance (long from, long to) 
    { 
        if (single_instance == null) 
            single_instance = new SingletonPrimeGenerator(from, to); 
